...
class BlockManager {
	...
	public function register_blocks() {
		...
		add_action('enqueue_block_editor_assets', function () use ($printable_js_data) {
			wp_add_inline_script('gutenova-editor', '
                ...
                window.gutenova.blockData = Object.assign({}, window.gutenova.blockData, ' . json_encode($printable_js_data) . ');
            ');
		});
	}
	...
	public function store_css() {
		...
		$css       = isset($_POST['css']) ? sanitize_text_field($_POST['css']) : null;
		$font_link = isset($_POST['font_link']) ? sanitize_text_field($_POST['font_link']) : null;

const Style = ({ settings, cssHelper }) => {
  ...
  cssHelper.add('.shopengine-tags', settings.shopengine_alignment, (val) => (`
    text-align: ${val};
  ...
  cssHelper.add('.shopengine-tags .product-tags-label', settings.shopengine_label_color, (val) => (`
    color: ${val};
   `)).add('.shopengine-tags .product-tags-label', settings.shopengine_label_decoration, (val) => (`
   text-decoration: ${val};
  `));

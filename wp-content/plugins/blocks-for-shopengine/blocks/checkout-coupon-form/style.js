...
const Style = ({settings, breakpoints, cssHelper})=>{ 
    const {blockId, shopengine_info_color, shopengine_info_bg, shopengine_info_link_color, shopengine_info_link_hover_color, shopengine_info_font_size, shopengine_info_font_weight, shopengine_info_line_height, shopengine_info_word_spacing, shopengine_info_border_style, shopengine_info_border_width, shopengine_info_border_color,shopengine_info_padding, shopengine_description_font_size, shopengine_description_font_weight, shopengine_description_line_height, shopengine_description_word_spacing, shopengine_description_color, shopengine_coupon_color,shopengine_coupon_bg_color, shopengine_coupon_font_size, shopengine_coupon_font_weight, shopengine_coupon_line_height, shopengine_coupon_word_spacing,shopengine_coupon_border_style, shopengine_coupon_border_width, shopengine_coupon_border_color, shopengine_coupon_border_radius, shopengine_coupon_padding, shopengine_apply_button_word_spacing,shopengine_apply_button_font_size, shopengine_apply_button_font_weight, shopengine_apply_button_text_transform, shopengine_apply_button_line_height, shopengine_button_color, shopengine_button_bg, shopengine_button_border_style, shopengine_border_width, shopengine_border_color, shopengine_border_radius, shopengine_button_padding, shopengine_button_hover_color, shopengine_button_hover_bg, shopengine_button_box_shadow_horizontal, shopengine_button_box_shadow_vertical, shopengine_button_box_shadow_blur, shopengine_button_box_shadow_spread, shopengine_button_box_shadow_position} = settings;
    ...
    cssHelper.add('.shopengine-checkout-coupon-form input, .shopengine-checkout-coupon-form input', shopengine_coupon_bg_color, (val) => {
        return `
        background-color: ${val} !important;
        `
    } );
    cssHelper.add('.shopengine-checkout-coupon-form input, .shopengine-checkout-coupon-form input::placeholder', shopengine_coupon_color, (val) => {
        return `
        color: ${val} !important;
        `
    } );

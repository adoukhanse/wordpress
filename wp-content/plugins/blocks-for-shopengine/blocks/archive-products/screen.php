...
?>
    <div class="shopengine-price-pos-<?php echo esc_attr($shopengine_price_reg_pos); ?>  elementor-align-<?php esc_attr_e($settings['shopengine_container_text_align']['desktop'], 'shopengine-gutenberg-addon') ?> <?php esc_attr_e($shopengine_group_btns_over_image, 'shopengine-gutenberg-addon'); ?>">

...
const Style = ({ settings, breakpoints, cssHelper }) => {
    ...
    if (settings.shopengine_add_to_cart_data_ordering_enable.desktop == true) {
        cssHelper.add(`
        .shopengine-archive-products.shopengine-hover-disable .products .product`, settings.shopengine_add_to_cart_data_ordering_enable, (val) => {
            return `
            display: flex; 
            flex-direction: row; 
            flex-wrap: wrap; 
    ...
    .shopengine-archive-products a.add_to_cart_button
        `, settings.add_to_cart_data_ordering, (val) => {
        return `
            order : ${val};
            `
    });
    ...
    cssHelper.add(`
    .shopengine-archive-products .shopengine-wishlist
        `, settings.wishlist_data_ordering, (val) => {
        return `
            order : ${val};
            `
    });
    ...
    cssHelper.add(`
    .shopengine-archive-products .shopengine-comparison
        `, settings.comparison_data_ordering, (val) => {
        return `
            order : ${val};
            `
    });
    ...
    cssHelper.add(`
    .shopengine-archive-products .shopengine-quickview-trigger
        `, settings.quick_view_data_ordering, (val) => {
        return `
            order : ${val};
            `
    });
    ...
    cssHelper.add('.shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist) i, .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist) span, .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist) svg, .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist) path, .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.shopengine-wishlist) a::before,.shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a.button:not(.shopengine-quickview-trigger)::before', shopengine_button_group_btn_clr, (val) => {
        return `
        fill  : ${val} !important;
        color : ${val} !important;
        `
    ...
    cssHelper.add(`
    .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.wc-forward) .button,
    .shopengine-archive-products ul li .loop-product--btns .loop-product--btns-inner a:not(.wc-forward) button,
    ...
    cssHelper.add('.shopengine-archive-products .woocommerce-pagination > ul > li > .page-numbers.current', shopengine_pagi_h_color, (val) => {
        return `
        color: ${val};
        `
    });

    cssHelper.add('.shopengine-archive-products .woocommerce-pagination > ul > li > .page-numbers:hover', shopengine_pagi_h_color, (val) => {
        return `
        color: ${val};
        `
    });

    cssHelper.add('.shopengine-archive-products .woocommerce-pagination > ul > li > .page-numbers:not(.dots).current,.shopengine-archive-products .woocommerce-pagination > ul > li > .page-numbers:not(.dots):hover', shopengine_pagi_h_bgcolor, (val) => {
        return `
        background-color: ${val};
        `
    });

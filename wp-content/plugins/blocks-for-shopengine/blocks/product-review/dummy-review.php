      ...
      <ol class="commentlist">
            ...
            <div id="comment-16" class="comment_container">
               ...
               <div class="comment-text">
                  ...
                  <p class="meta">
                     ...
                     <em class="woocommerce-review__verified verified"><?php esc_html_e('(verified owner)', 'shopengine-gutenberg-addon'); ?></em> <span class="woocommerce-review__dash"><?php echo esc_html('–', 'shopengine-gutenberg-addon'); ?></span> 
					 <time class="woocommerce-review__published-date" datetime="2021-05-26T13:07:16+00:00"><?php echo esc_html('May 26, 2021', 'shopengine-gutenberg-addon'); ?></time>
                  </p>
                  <div class="description">
                     <?php echo wp_kses_post('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>'); ?>
                  </div>
               </div>
            </div>
         </li>
         ...
         <li class="review byuser comment-author-admin bypostauthor odd alt thread-odd thread-alt depth-1" id="li-comment-17">
            <div id="comment-17" class="comment_container">
               <img alt="<?php echo esc_attr('Review Avatar', 'shopengine-gutenberg-addon') ?>" src="<?php echo esc_url('https://secure.gravatar.com/avatar/7064f941bf63e90bfe35449c62586bc8?s=60&d=mm&r=g'); ?>" class="avatar avatar-60 photo" height="60" width="60" loading="lazy">
               <div class="comment-text">
                  ...
                  <div class="description">
					 <?php echo wp_kses_post('<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>'); ?>
                  </div>
               </div>
            </div>
         </li>

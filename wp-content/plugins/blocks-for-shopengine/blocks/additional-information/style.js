...
const Style = ({ settings, breakpoints, cssHelper }) => {
   ...
   cssHelper.add('.shopengine-additional-information tr td, .shopengine-additional-information tr th, .shopengine-additional-information tr p', settings.shopengine_product_addi_info_table_font_Line_height, (val) => {
      return `
      line-height: ${val}px;
      `
   });
   cssHelper.add('.shopengine-additional-information tr td, .shopengine-additional-information tr th, .shopengine-additional-information tr p', settings.shopengine_product_addi_info_table_font_letter_spacing, (val) => {
      return `

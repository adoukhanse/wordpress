const Style = ({ settings, cssHelper }) => {
	...
	text-transform: ${val};
    `)).add('.shopengine-countdown-clock .se-clock-item span:first-child', settings.shopengine_countdown_clock_label_line_height, (val) => (`
	line-height: ${val}px;
	...
	text-transform: ${val};
    `)).add('.shopengine-deal-products-widget .deal-products__desc--name a', settings.shopengine_content_style_title_line_height, (val) => (`
	line-height: ${val}px;

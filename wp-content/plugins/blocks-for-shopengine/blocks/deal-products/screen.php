    ...
    <div class="shopengine-deal-products-widget">
        <div class="deal-products-container">
			...
			if($query->have_posts()): while($query->have_posts()): $query->the_post();
                ...
                <div class="deal-products" data-deal-data='<?php echo wc_esc_json( json_encode($deal_data), true ); ?>'>
                    ...
                    <div class="deal-products__top">
						...
						<?php if($settings['shopengine_percentage_badge']['desktop'] && $product->get_regular_price() !== 0): ?>
                            <span class="shopengine-offer-badge"> -<?php echo esc_html(100 - round($offPercentage, 2)); ?><?php echo esc_html__('%', 'shopengine-gutenberg-addon'); ?></span>
						<?php endif; ?>
                     ...
                     <span class="clock-days-label"><?php echo esc_html__('Days', 'shopengine-gutenberg-addon') ?></span>
                  </span>
								<?php endif; ?>

                                <span class="se-clock-item">
                  <span class="clock-hou"></span>
                  <span class="clock-hou-label"><?php echo esc_html__('Hours', 'shopengine-gutenberg-addon') ?></span>
                </span>

                                <span class="se-clock-item">
                  <span class="clock-min"></span>
                  <span class="clock-min-label"><?php echo esc_html__('Min', 'shopengine-gutenberg-addon') ?></span>
                </span>

                                <span class="se-clock-item">
                  <span class="clock-sec"></span>
                  <span class="clock-sec-label"><?php echo esc_html__('Sec', 'shopengine-gutenberg-addon'); ?></span>
                </span>
                            </div>
                    ...
                    <div class="deal-products__prices">
                        <ins>
                            <span class="woocommerce-Price-amount amount"><?php echo \Shopengine\Utils\Helper::kses($price) ?> </span>
                        </ins>
                    ...
                    <div class="deal-products__grap">
                        <canvas class="deal-products__grap--line"
                                ...
                                data-settings='<?php echo wc_esc_json( json_encode($progress_data), true ); ?>'></canvas>
                        <div class="deal-products__grap__sells">
                            <div class="deal-products__grap--available">
                                <span><?php echo esc_html__('Available:', 'shopengine-gutenberg-addon') ?></span>
                                <span class="avl_num"><?php echo esc_html($available); ?></span>
                            </div>
                            <div class="deal-products__grap--sold">
                                <span><?php echo esc_html__('Sold:', 'shopengine-gutenberg-addon') ?></span>
            ...
            elseif($post_type == \ShopEngine\Core\Template_Cpt::TYPE):
				echo esc_html__('No deal products available', 'shopengine-gutenberg-addon');
			endif;
			wp_reset_postdata(); ?>
        </div>
    </div>

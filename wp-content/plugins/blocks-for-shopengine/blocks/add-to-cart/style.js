const Style = ({ settings, cssHelper }) => {
    ...
    cssHelper.add('.shopengine-swatches .quantity-wrap', settings.quantity_order, (val) => (`
        order: ${val};
    `)).add('.shopengine-swatches .single_add_to_cart_button', settings.add_to_cart_order, (val) => (`
        order: ${val};
    `)).add('.shopengine-swatches .shopengine-quick-checkout-button', settings.quick_checkout_order, (val) => (`
        order: ${val};
    `)).add('.shopengine-swatches .shopengine-wishlist.badge', settings.wishlist_order, (val) => (`
        order: ${val};
    `)).add('.shopengine-swatches .shopengine-comparison.badge', settings.comparison_order, (val) => (`
        order: ${val};
    `)).add('.shopengine-swatches .partial_payment', settings.partial_payment_order, (val) => (`
        order: ${val};
    `)).add('a', {}, () => (`
    ...
    `)).add('.shopengine-swatches .quantity .qty', settings.add_cart_quantity_font_style, (val) => (`
        font-style: ${val};
    `)).add('.shopengine-swatches .quantity .qty', settings.add_cart_quantity_letter_spacing, (val) => (`
        letter-spacing: ${val}px;
    ...
    `)).add('.shopengine-swatches .quantity-wrap.both .minus', settings.shopengine_add_cart_quantity_border_radius, (val) => (`
    border-radius: 0;

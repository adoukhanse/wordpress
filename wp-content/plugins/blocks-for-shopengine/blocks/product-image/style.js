...
`));
    cssHelper.add(`.shopengine-product-image .woocommerce-product-gallery__trigger + .woocommerce-product-gallery__wrapper,
    .shopengine-product-image .img-thumbnail,
    .shopengine-product-image .flex-viewport`, settings.shopengine_image_border_radius, (val) => (`
...
`));
    ...
    margin-right: ${val}%;
`));
    cssHelper.add(`.woocommerce .shopengine-product-image .flex-control-thumbs img,
    .woocommerce .shopengine-product-image .product-thumbs-slider .img-thumbnail,
    .woocommerce .woocommerce-product-gallery #product-thumbnails-carousel .slick-slide:hover img, .woocommerce .woocommerce-product-gallery #product-thumbnails-carousel .slick-current img`, settings.shopengine_thumbs_border, (val) => (`
    color: ${val};
`));
    cssHelper.add(`.woocommerce .shopengine-product-image .flex-control-thumbs img,.woocommerce .shopengine-product-image .product-thumbs-slider .img-thumbnail,.woocommerce-product-gallery #product-thumbnails-carousel .slick-slide:hover img,
    .woocommerce-product-gallery #product-thumbnails-carousel .slick-current img`, settings.shopengine_thumbs_border_radius, (val) => (`
    border-radius: ${val}px;
`));

...
if(!$product->get_sku()) {
	...
	if($block->is_editor) {
		echo esc_html__('This product has no sku', 'shopengine-gutenberg-addon');
	}
    ...
    <div class="shopengine-sku">
        ...
        <?php if(wc_product_sku_enabled() && ($product->get_sku() || $product->is_type('variable'))) : ?>
            ...
            <span class="sku-wrapper">
                ...
                <span class="sku-value"><?php echo ($sku = $product->get_sku()) ? $sku : esc_html__('N/A', 'shopengine-gutenberg-addon'); ?></span>

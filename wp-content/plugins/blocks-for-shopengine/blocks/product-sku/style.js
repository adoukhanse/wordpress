const Style = ({ settings, breakpoints, cssHelper }) => {
    ...
    /*  cssHelper.add('.shopengine-sku', settings.mk_product_sku_align, (val) => (`
             text-align : ${val};
         `))
     cssHelper.add('.shopengine-sku', settings.mk_font_size, (val) => (`
             text-align : ${val};
         `)) */

    cssHelper.add('.shopengine-sku', settings.shopengine_product_sku_align, (val) => (`
        text-align : ${val};
    `))

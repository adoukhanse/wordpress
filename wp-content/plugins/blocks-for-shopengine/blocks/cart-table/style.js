...
const Style = ({settings, breakpoints, cssHelper})=>{
    ...
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_font_size, (val) => {
        return `
        font-size: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_font_weight, (val) => {
        return `
        font-weight: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_text_transform, (val) => {
        return `
        text-transform: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_line_height, (val) => {
        return `
        line-height: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_letter_spacing, (val) => {
        return `
        letter-spacing: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__head div', settings.shopengine_table_head_word_spacing, (val) => {
        return `
        word-spacing: ${val}px;
        `
    } )
    ...
    cssHelper.add('.shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td a, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td .amount, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td bdi)', settings.shopengine_table_body_font_size, (val) => {
        return `
        font-size: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td a, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td .amount, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td bdi)', settings.shopengine_table_body_font_weight, (val) => {
        return `
        font-weight: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td a, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td .amount, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td bdi)', settings.shopengine_table_body_text_transform, (val) => {
        return `
        text-transform: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td a, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td .amount, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td bdi)', settings.shopengine_table_body_line_height, (val) => {
        return `
        line-height: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td a, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td .amount, .shopengine-cart-table .shopengine-table__body .shopengine-table__body-item--td bdi)', settings.shopengine_table_body_word_spacing, (val) => {
        return `
        word-spacing: ${val}px;
        `
    } )
    ...
    cssHelper.add('.shopengine-cart-table .shopengine-table__footer .shopengine-footer-button', settings.shopengine_table_footer_button_font_size, (val) => {
        return `
        font-size: ${val}px;
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__footer .shopengine-footer-button', settings.shopengine_table_footer_button_font_weight, (val) => {
        return `
        font-weight: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__footer .shopengine-footer-button', settings.shopengine_table_footer_button_text_transform, (val) => {
        return `
        text-transform: ${val};
        `
    } )
    cssHelper.add('.shopengine-cart-table .shopengine-table__footer .shopengine-footer-button', settings.shopengine_table_footer_button_word_spacing, (val) => {
        return `
        word-spacing: ${val}px;
        `
    } )

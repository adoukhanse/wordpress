...
const Style = ({settings, breakpoints, cssHelper})=>{
    ...
    `,settings.shopengine_car_button, (val) => (`
        display: ${val ? "block" : "none"};
    `))
    if(!settings.shopengine_enable_slider){
        cssHelper.add(`
        .shopengine-related ul.products
        `,settings.shopengine_slides_per_view, (val) => (`
            display: grid; 
    ...
    if(settings.shopengine_item_alignment.desktop=== 'left'){
        cssHelper.add(`
        .shopengine-related .related , 
    ...
    if(settings.shopengine_item_alignment.desktop=== 'center'){
        cssHelper.add(`
        .shopengine-related .related , 
        .shopengine-related .price
        `,{}, (val) => (`
    ...
    if(settings.shopengine_item_alignment.desktop=== 'right'){
        cssHelper.add(`
        .shopengine-related .related , 
        .shopengine-related .price
        `,{}, (val) => (`
    ...
    cssHelper.add('.shopengine-related .woocommerce-loop-product__title',
    settings.shopengine_title_letter_spacing, (val) => {
        return `
        letter-spacing: ${val}px;
        `
    } )
    ...
    .shopengine-related .woocommerce-loop-product__title
        ...
        .shopengine-related .price del span,
        .shopengine-related .price del .amount
            `,
    ...
    cssHelper.add(`
        ...
        .shopengine-related .price del
        `,
    settings.shopengine_price_text_transform, (val) => {
        return `
        text-transform: ${val};
        `
    } )
    ...
    cssHelper.add(`
        ...
        .shopengine-related .price del
        `,
    settings.shopengine_price_letter_spacing, (val) => {
        return `
        letter-spacing: ${val}px;
        `
    } )
    ...
    cssHelper.add(`
        ...
        .shopengine-related .related .added_to_cart
        `,
    settings.shopengine_cart_letter_spacing, (val) => {
        return `
        letter-spacing: ${val}px;
        `
    } )

...
$rating_list       = $settings['rating_list']['desktop'];
...
switch($product_by) {
	...
	case 'sale':
		...
		break;
	case 'viewed':
		$viewed_products        = !empty($_COOKIE['shopengine_recent_viewed_product']) ? (array)explode('|', wp_unslash(sanitize_text_field($_COOKIE['shopengine_recent_viewed_product']))) : [];
				...
				<?php while($productQuery->have_posts()) : $productQuery->the_post();
                    ...
                    <div class="shopengine-single-product-item">
                        ...
                        <div class="product-thumb">
                            ...
                            <!-- add to cart -->
                            <div class="overlay-add-to-cart position-<?php echo $settings["shopengine_product_hover_position"]["desktop"] ?? 'bottom'; ?>">
                                            ...
                                            <li>
                                                <a href="<?php echo esc_url(get_term_link($product_cat)); ?>">
													...
													if($key !== (count($slice_product_cats) - 1)) {
														echo esc_html_e(',', 'shopengine-gutenberg-addon');
													}
													?>
                                                </a>
                                            </li>

...
class Helper {
	...
	public static function _product_image($settings = null) {
        ...
        <div class='product-thumb'>
            ...
            <!-- show group buttons -->
			<?php
			if(isset($settings['shopengine_group_btns']['desktop']) && $settings['shopengine_group_btns']['desktop'] == true) {
	...
	public static function _product_category($settings = null) {
		...
		if($terms_count > 0) {
			...
			foreach($terms as $key => $term) {
				...
				echo "<li><a href='" . esc_url(get_term_link($term->term_id)) . "'>" . esc_html($term->name) . $sperator . "</a></li>";
			}
			echo "</ul></div>";
		}
	}
